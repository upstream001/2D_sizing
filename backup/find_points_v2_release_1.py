...
class StrawberryPointFinder:
    ...
    def visualize_results(self, points_list, image, pca_results_list, pc1_endpoints_list, line_results_list, save_path=None):
        ...
        for i, (points, pca_results, pc1_endpoints, line_results) in enumerate(zip(points_list, pca_results_list, pc1_endpoints_list, line_results_list)):
            ...
            # 绘制掩码点
            ax.scatter(points[:, 0], points[:, 1], c=color, s=0.5, alpha=0.6)
    ...
    def visualize_original_with_connections(self, image, pca_results_list, pc1_endpoints_list, line_results_list, save_path=None):
        """
        只显示原图和风筝形状连接线的简洁可视化
    ...
    def analyze_image(self, image_path, conf_threshold=0.25, save_path=None):
        ...
        fig = self.visualize_results(points_list, image, pca_results_list, pc1_endpoints_list, line_results_list, save_path)
